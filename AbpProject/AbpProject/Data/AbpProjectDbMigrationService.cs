...
{
    public ILogger<AbpProjectDbMigrationService> Logger { get; set; } = null!;

    private readonly IDataSeeder _dataSeeder;
    private readonly AbpProjectDbSchemaMigrator _dbSchemaMigrator;
    ...
    public AbpProjectDbMigrationService(
        ...
        AbpProjectDbSchemaMigrator dbSchemaMigrator,
    ...
    public async Task MigrateAsync()
    {
        ...
        if (AbpProjectModule.IsMultiTenant)
        {
    ...
    private async Task SeedDataAsync(Tenant? tenant = null)
    {
        ...
        // เพิ่ม flag สำหรับ Development mode
        if (_hostEnvironment.IsDevelopment())
        {
            seedContext.WithProperty("IsDevelopment", true);
            Logger.LogInformation("Development mode detected. Seeding dev user (username: dev, password: 123456)...");
        }
    ...
    private string GetEntityFrameworkCoreProjectFolderPath()
    {
        ...
        return Path.Combine(slnDirectoryPath, "AbpProject");
    }
